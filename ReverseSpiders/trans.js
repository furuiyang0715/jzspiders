                        ...
                        if (O && O.location.href !== d.iframeSrc || w) {
                            ...
                            try {
                                ...
                                if (u || d.textarea) {
                                    ...
                                    "xml" === c && !y.responseXML && y.responseText && (y.responseXML = q(y.responseText));
                                try {
                                    D = R(y, c, d)
                                } catch (e) {
                                    a = "parsererror",
    ...
    return function(e, t) {
        ...
        function a(e, t, n) {
            ...
            !o || "queue" !== n && q._data(e, i) || "mark" !== n && q._data(e, a) || setTimeout(function() {
                q._data(e, i) || q._data(e, a) || (q.removeData(e, r, !0),
                o.fire())
            }, 0)
        }
        function o() {
            ...
            if (1 === t.nodeType && q.hasData(e)) {
                ...
                if (s) {
                    ...
                    for (n in s)
                        for (r = 0,
                        i = s[n].length; r < i; r++)
                            q.event.add(t, n + (s[n][r].namespace ? "." : "") + s[n][r].namespace, s[n][r], s[n][r].data)
                }
        ...
        var O = e.document
          ...
          , q = function() {
            ...
            }, E = L.userAgent, j = Object.prototype.toString, N = Object.prototype.hasOwnProperty, A = Array.prototype.push, D = Array.prototype.slice, F = String.prototype.trim, q = Array.prototype.indexOf, M = {};
        ...
        q.extend({
            Deferred: function(e) {
                var t, n = q.Callbacks("once memory"), r = q.Callbacks("once memory"), i = q.Callbacks("memory"), a = "pending", o = {
                    resolve: n,
                    reject: r,
                    notify: i
                }, s = {
            ...
            when: function(e) {
                ...
                if (r > 1) {
                    for (; n < r; n++)
                        t[n] && t[n].promise && q.isFunction(t[n].promise) ? t[n].promise().then(function(e) {
                            return function(n) {
        ...
        q.extend({
            ...
            data: function(e, n, r, i) {
                if (q.acceptData(e)) {
                    q.expando;
                    var a, o, s, l = "string" == typeof n, c = e.nodeType, u = c ? q.cache : e, d = c ? e[q.expando] : e[q.expando] && q.expando, f = "events" === n;
                    if (d && u[d] && (f || i || u[d].data) || !l || r !== t)
                        return d || (c ? e[q.expando] = d = ++q.uuid : d = q.expando),
                        u[d] || (u[d] = {},
                        c || (u[d].toJSON = q.noop)),
                        ...
                        f && !o[n] ? a.events : (l ? null == (s = o[n]) && (s = o[q.camelCase(n)]) : s = o,
                        s)
                }
            },
                ...
                if (q.acceptData(e)) {
                    ...
                    if (l[c]) {
                        if (t && (r = n ? l[c] : l[c].data)) {
                            for ((a = 0,
                            o = (t = q.isArray(t) ? t : t in r ? [t] : (t = q.camelCase(t))in r ? [t] : t.split(" ")).length); a < o; a++)
                                delete r[t[a]];
                            if (!(n ? i : q.isEmptyObject)(r))
                                return
                        }
                        (n || (delete l[c].data,
                        i(l[c]))) && (q.support.deleteExpando || !l.setInterval ? delete l[c] : l[c] = null,
                        s && (q.support.deleteExpando ? delete e[q.expando] : e.removeAttribute ? e.removeAttribute(q.expando) : e[q.expando] = null))
                    }
                }
            },
        ...
        q.fn.extend({
            data: function(e, n) {
                var i, a, o, s = null;
                if (void 0 === e) {
                    if (this.length && (s = q.data(this[0]),
                    1 === this[0].nodeType && !q._data(this[0], "parsedAttrs"))) {
                        for (var l = 0, c = (a = this[0].attributes).length; l < c; l++)
                            0 === (o = a[l].name).indexOf("data-") && (o = q.camelCase(o.substring(5)),
                            r(this[0], o, s[o]));
                ...
                i[1] = i[1] ? "." + i[1] : "",
                n === t ? ((s = this.triggerHandler("getData" + i[1] + "!", [i[0]])) === t && this.length && (s = q.data(this[0], e),
                s = r(this[0], e, s)),
        ...
        q.extend({
            ...
            _unmark: function(e, t, n) {
                ...
                t) {
                    ...
                    i ? q._data(t, r, i) : (q.removeData(t, r, !0),
                    a(t, n, "mark"))
                }
            },
            ...
            dequeue: function(e, t) {
                ...
                n.length || (q.removeData(e, t + "queue " + t + ".run", !0),
                a(e, t, "queue"))
            }
        }),
        q.fn.extend({
            ...
            promise: function(e, n) {
                ...
                e = t),
                e = e || "fx";
                for (var i, a = q.Deferred(), o = this, s = o.length, l = 1, c = e + "defer", u = e + "queue", d = e + "mark"; s--; )
                    (i = q.data(o[s], c, t, !0) || (q.data(o[s], u, t, !0) || q.data(o[s], d, t, !0)) && q.data(o[s], c, q.Callbacks("once memory"), !0)) && (l++,
                    i.add(r));
                return r(),
                a.promise()
            }
        });
        var z, P, B, U = /[\n\t\r]/g, W = /\s+/, $ = /\r/g, X = /^(?:button|input)$/i, V = /^(?:button|input|object|select|textarea)$/i, Y = /^a(?:rea)?$/i, Z = /^(?:autofocus|autoplay|async|checked|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped|selected)$/i, K = q.support.getSetAttribute;
        q.fn.extend({
            attr: function(e, t) {
            ...
            toggleClass: function(e, t) {
                ...
                return q.isFunction(e) ? this.each(function(n) {
                    ...
                    if ("string" === n)
                        for (var i, a = 0, o = q(this), s = t, l = e.split(W); i = l[a++]; )
                        ...
                        this.className = this.className || !1 === e ? "" : q._data(this, "__className__") || "")
                })
            },
            hasClass: function(e) {
            ...
            val: function(e) {
                var n, r, i, a = this[0];
                return arguments.length ? (i = q.isFunction(e),
        ...
        q.extend({
                ...
                select: {
                    get: function(e) {
                        ...
                        r = l ? a + 1 : s.length; n < r; n++)
                            if ((i = s[n]).selected && (q.support.optDisabled ? !i.disabled : null === i.getAttribute("disabled")) && (!i.parentNode.disabled || !q.nodeName(i.parentNode, "optgroup"))) {
                                if (t = q(i).val(),
                                l)
                                    return t;
                                o.push(t)
            ...
            attr: function(e, n, r, i) {
                ...
                return e && 3 !== l && 8 !== l && 2 !== l ? i && n in q.attrFn ? q(e)[n](r) : "getAttribute"in e ? ((s = 1 !== l || !q.isXMLDoc(e)) && (n = n.toLowerCase(),
                o = q.attrHooks[n] || (Z.test(n) ? P : z)),
                r !== t ? null === r ? (q.removeAttr(e, n),
                t) : o && "set"in o && s && (a = o.set(e, r, n)) !== t ? a : (e.setAttribute(n, "" + r),
                r) : o && "get"in o && s && null !== (a = o.get(e, n)) ? a : null === (a = e.getAttribute(n)) ? t : a) : q.prop(e, n, r) : t
            },
            ...
            prop: function(e, n, r) {
                ...
                return e && 3 !== o && 8 !== o && 2 !== o ? ((1 !== o || !q.isXMLDoc(e)) && (n = q.propFix[n] || n,
                a = q.propHooks[n]),
        ...
        P = {
            ...
            set: function(e, t, n) {
                var r;
                return !1 === t ? q.removeAttr(e, n) : ((r = q.propFix[n] || n)in e && (e[r] = !0),
        ...
        q.attrHooks.tabindex.set = z.set,
        ...
        q.event = {
            add: function(e, n, r, i, a) {
                ...
                if (3 !== e.nodeType && 8 !== e.nodeType && n && r && (o = q._data(e))) {
                    ...
                    c = 0; c < n.length; c++)
                        ...
                        a && (p.quick = re(a),
                        !p.quick && q.expr.match.POS.test(a) && (p.isPositional = !0)),
                ...
                if (m && (u = m.events)) {
                    ...
                    i = 0; i < t.length; i++) {
                        ...
                        n || s || r || d.remove)
                            ...
                            p.length = 0;
                        0 === p.length && l !== p.length && (d.teardown && !1 !== d.teardown.call(e, s) || q.removeEvent(e, o, m.handle),
                        delete u[o])
                    }
                    q.isEmptyObject(u) && ((f = m.handle) && (f.elem = null),
                    q.removeData(e, ["events", "handle"], !0))
                }
            },
            customEvent: {
                getData: !0,
            ...
            trigger: function(n, r, i, a) {
                if (!i || 3 !== i.nodeType && 8 !== i.nodeType) {
                    ...
                    v.sort()),
                    i && !q.event.customEvent[g] || q.event.global[g])
                        ...
                        i) {
                            if (n.result = t,
                            n.target || (n.target = i),
                            (r = null != r ? q.makeArray(r) : []).unshift(n),
                            !(f = q.event.special[g] || {}).trigger || !1 !== f.trigger.apply(i, r)) {
                                if (h = [[i, f.bindType || g]],
                                !a && !f.noBubble && !q.isWindow(i)) {
                                ...
                                n.type = h[l][1],
                                (p = (q._data(c, "events") || {})[n.type] && q._data(c, "handle")) && p.apply(c, r),
                                (p = d && c[d]) && q.acceptData(c) && p.apply(c, r),
                                !n.isPropagationStopped()); l++)
                                    ;
                                return n.type = g,
                                n.isDefaultPrevented() || f._default && !1 !== f._default.apply(i.ownerDocument, r) || "click" === g && q.nodeName(i, "a") || !q.acceptData(i) || d && i[g] && ("focus" !== g && "blur" !== g || 0 !== n.target.offsetWidth) && !q.isWindow(i) && ((u = i[d]) && (i[d] = null),
                                q.event.triggered = g,
                                i[g](),
                                q.event.triggered = t,
                                u && (i[d] = u)),
                            ...
                            o = q.cache;
                            for (l in o)
                                o[l].events && o[l].events[g] && q.event.trigger(n, r, o[l].handle.elem, !0)
                        }
                }
            },
            dispatch: function(n) {
                n = q.event.fix(n || e.event);
                var r, i, a, o, s, l, c, u, d, f, p = (q._data(this, "events") || {})[n.type] || [], h = p.delegateCount, m = [].slice.call(arguments, 0), g = !n.exclusive && !n.namespace, v = (q.event.special[n.type] || {}).handle, y = [];
                if (m[0] = n,
            ...
            fix: function(e) {
                if (e[q.expando])
                    return e;
                var n, r, i = e, a = q.event.fixHooks[e.type] || {}, o = a.props ? this.props.concat(a.props) : this.props;
                for (e = q.Event(i),
                n = o.length; n; )
                    e[r = o[--n]] = i[r];
        ...
        q.removeEvent = O.removeEventListener ? function(e, t, n) {
        ...
        q.each({
            ...
            q.event.special[e] = q.event.special[t] = {
                ...
                handle: function(e) {
                    ...
                    a.selector;
                    return i && a.origType !== e.type && (i === r || q.contains(r, i)) || (t = e.type,
                    e.type = a.origType,
        ...
        q.support.changeBubbles || (q.event.special.change = {
            setup: function() {
                if (G.test(this.nodeName))
                    return "checkbox" !== this.type && "radio" !== this.type || (q.event.add(this, "propertychange._change", function(e) {
        ...
        q.extend({
            ...
            dir: function(e, n, r) {
                for (var i = [], a = e[n]; a && 9 !== a.nodeType && (r === t || 1 !== a.nodeType || !q(a).is(r)); )
        ...
        q.fn.extend({
            ...
            html: function(e) {
                ...
                if ("string" != typeof e || xe.test(e) || !q.support.leadingWhitespace && me.test(e) || Se[(ve.exec(e) || ["", ""])[1].toLowerCase()])
                    q.isFunction(e) ? this.each(function(t) {
                        var n = q(this);
                    ...
                    try {
                        for (var n = 0, r = this.length; n < r; n++)
                            1 === this[n].nodeType && (q.cleanData(this[n].getElementsByTagName("*")),
                            this[n].innerHTML = e)
                    } catch (t) {
                        this.empty().append(e)
                    }
            ...
            domManip: function(e, n, r) {
                var i, a, o, s, l = e[0], c = [];
                if (!q.support.checkClone && 3 === arguments.length && "string" == typeof l && _e.test(l))
                    return this.each(function() {
                ...
                if (this[0]) {
                    if (s = l && l.parentNode,
                    i = q.support.parentNode && s && 11 === s.nodeType && s.childNodes.length === this.length ? {
                        fragment: s
                    } : q.buildFragment(e, this, c),
                    o = i.fragment,
                    a = 1 === o.childNodes.length ? o = o.firstChild : o.firstChild) {
                        n = n && q.nodeName(a, "tr");
                        for (var u = 0, f = this.length, p = f - 1; u < f; u++)
                            r.call(n ? d(this[u]) : this[u], i.cacheable || f > 1 && u < p ? q.clone(o, !0, !0) : o)
                    }
                    c.length && q.each(c, v)
                }
                return this
        ...
        q.buildFragment = function(e, t, n) {
            ...
            1 === e.length && "string" == typeof s && s.length < 512 && o === O && "<" === s.charAt(0) && !we.test(s) && (q.support.checkClone || !_e.test(s)) && !q.support.unknownElems && Te.test(s) && (i = !0,
            (a = q.fragments[s]) && 1 !== a && (r = a)),
        ...
        q.extend({
            ...
            clean: function(e, t, n, r) {
                            ...
                            if (be.test(o)) {
                                ...
                                if (!q.support.tbody) {
                                    ...
                                    for (a = m.length - 1; a >= 0; --a)
                                        q.nodeName(m[a], "tbody") && !m[a].childNodes.length && m[a].parentNode.removeChild(m[a])
                                }
                ...
                if (n)
                    ...
                    ,
                    l = 0; s[l]; l++)
                        if (!r || !q.nodeName(s[l], "script") || s[l].type && "text/javascript" !== s[l].type.toLowerCase()) {
                            if (1 === s[l].nodeType) {
            ...
            cleanData: function(e) {
                for (var t, n, r, i = q.cache, a = q.event.special, o = q.support.deleteExpando, s = 0; null != (r = e[s]); s++)
                    if ((!r.nodeName || !q.noData[r.nodeName.toLowerCase()]) && (n = r[q.expando])) {
                        if ((t = i[n]) && t.events) {
                            for (var l in t.events)
                                a[l] ? q.event.remove(r, l) : q.removeEvent(r, l, t.handle);
        ...
        var je, Ne, Ae, De = /alpha\([^)]*\)/i, Oe = /opacity=([^)]*)/, Le = /([A-Z]|^ms)/g, Fe = /^-?\d+(?:px)?$/i, qe = /^-?\d/, Me = /^([\-+])=([\-+.\de]+)/, Re = {
            position: "absolute",
            visibility: "hidden",
            display: "block"
        ...
        q.extend({
            ...
            style: function(e, n, r, i) {
                if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                    ...
                    if (!("string" == (o = typeof r) && (a = Me.exec(r)) && (r = +(a[1] + 1) * +a[2] + parseFloat(q.css(e, n)),
                    o = "number"),
                    null == r || "number" === o && isNaN(r) || ("number" !== o || q.cssNumber[s] || (r += "px"),
        ...
        q.each(["height", "width"], function(e, t) {
            q.cssHooks[t] = {
                get: function(e, n, r) {
                    var i;
                    if (n)
                        return 0 !== e.offsetWidth ? y(e, t, r) : (q.swap(e, Re, function() {
                            i = y(e, t, r)
                        }),
                        i)
                },
        ...
        q.support.opacity || (q.cssHooks.opacity = {
            ...
            set: function(e, t) {
                ...
                n.zoom = 1,
                t >= 1 && "" === q.trim(a.replace(De, "")) && (n.removeAttribute("filter"),
        ...
        O.defaultView && O.defaultView.getComputedStyle && (Ne = function(e, n) {
            ...
            (i = e.ownerDocument.defaultView) ? ((a = i.getComputedStyle(e, null)) && ("" !== (r = a.getPropertyValue(n)) || q.contains(e.ownerDocument.documentElement, e) || (r = q.style(e, n))),
            r) : t
        }
        ),
        ...
        var ze, Pe, Be = /%20/g, Ue = /\[\]$/, We = /\r?\n/g, $e = /#.*$/, Xe = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm, Ve = /^(?:color|date|datetime|datetime-local|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i, Ye = /^(?:about|app|app\-storage|.+\-extension|file|res|widget):$/, Ze = /^(?:GET|HEAD)$/, Ke = /^\/\//, Ge = /\?/, Je = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, Qe = /^(?:select|textarea)/i, et = /\s+/, tt = /([?&])_=[^&]*/, nt = /^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+))?)?/, rt = q.fn.load, it = {}, at = {}, ot = ["*/"] + ["*"];
        try {
            ze = F.href
        } catch (e) {
        ...
        q.fn.extend({
            load: function(e, n, r) {
                ...
                var o = "GET";
                n && (q.isFunction(n) ? (r = n,
                n = t) : "object" == typeof n && (n = q.param(n, q.ajaxSettings.traditional),
                o = "POST"));
                var s = this;
                return q.ajax({
                    url: e,
        ...
        q.extend({
            ...
            ajaxSetup: function(e, t) {
                return t ? w(e, q.ajaxSettings) : (t = e,
                e = q.ajaxSettings),
                w(e, t),
                e
            },
            ...
            ajax: function(e, n) {
                function r(e, n, r, o) {
                    if (2 !== w) {
                        ...
                        if (e >= 200 && e < 300 || 304 === e)
                            if (f.ifModified && ((b = T.getResponseHeader("Last-Modified")) && (q.lastModified[i] = b),
                            (x = T.getResponseHeader("Etag")) && (q.etag[i] = x)),
                            304 === e)
                                C = "notmodified",
                                c = !0;
                            else
                ...
                e = t),
                n = n || {};
                var i, a, o, s, l, c, u, d, f = q.ajaxSetup({}, n), p = f.context || f, h = p !== f && (p.nodeType || p instanceof q) ? q(p) : q.event, m = q.Deferred(), g = q.Callbacks("once memory"), v = f.statusCode || {}, y = {}, b = {}, w = 0, T = {
                    readyState: 0,
                ...
                f.dataTypes = q.trim(f.dataType || "*").toLowerCase().split(et),
                ...
                q.lastModified[i] && T.setRequestHeader("If-Modified-Since", q.lastModified[i]),
                q.etag[i] && T.setRequestHeader("If-None-Match", q.etag[i])),
            ...
            param: function(e, n) {
                ...
                if (n === t && (n = q.ajaxSettings.traditional),
        ...
        q.ajaxPrefilter("json jsonp", function(t, n, r) {
            ...
            if ("jsonp" === t.dataTypes[0] || !1 !== t.jsonp && (lt.test(t.url) || i && lt.test(t.data))) {
                var a, o = t.jsonpCallback = q.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s = e[o], l = t.url, c = t.data, u = "$1" + o + "$2";
        ...
        q.fn.extend({
            show: function(e, t, n) {
                ...
                for (var a = 0, o = this.length; a < o; a++)
                    ...
                    q._data(r, "olddisplay") || "none" !== i || (i = r.style.display = ""),
                    "" === i && "none" === q.css(r, "display") && q._data(r, "olddisplay", A(r.nodeName)));
                for (a = 0; a < o; a++)
                    (r = this[a]).style && ("" !== (i = r.style.display) && "none" !== i || (r.style.display = q._data(r, "olddisplay") || ""));
                return this
            },
            hide: function(e, t, n) {
                if (e || 0 === e)
                ...
                for (var r, i, a = 0, o = this.length; a < o; a++)
                    (r = this[a]).style && ("none" === (i = q.css(r, "display")) || q._data(r, "olddisplay") || q._data(r, "olddisplay", i));
                for (a = 0; a < o; a++)
            ...
            animate: function(e, t, n, r) {
                function i() {
                    ...
                    var t, n, r, i, o, s, l, c, u, d = q.extend({}, a), f = 1 === this.nodeType, p = f && q(this).is(":hidden");
                    ...
                    for (r in e) {
                        ...
                        delete e[r]),
                        n = e[t],
                        q.isArray(n) ? (d.animatedProperties[t] = n[1],
                        ...
                        "inline" === q.css(this, "display") && "none" === q.css(this, "float") && (q.support.inlineBlockNeedsLayout && "inline" !== A(this.nodeName) ? this.style.zoom = 1 : this.style.display = "inline-block"))
                    }
                    null != d.overflow && (this.style.overflow = "hidden");
                    for (r in e)
                        i = new q.fx(this,d,r),
                        n = e[r],
                        vt.test(n) ? (u = q._data(this, "toggle" + r) || ("toggle" === n ? p ? "show" : "hide" : 0)) ? (q._data(this, "toggle" + r, "show" === u ? "hide" : "show"),
                        i[u]()) : i[n]() : (o = yt.exec(n),
                        s = i.cur(),
                        o ? (l = parseFloat(o[2]),
                        "px" !== (c = o[3] || (q.cssNumber[r] ? "" : "px")) && (q.style(this, r, (l || 1) + c),
                        s = (l || 1) / i.cur() * s,
                        q.style(this, r, s + c)),
                        o[1] && (l = ("-=" === o[1] ? -1 : 1) * l + s),
                ...
                var a = q.speed(t, n, r);
                return q.isEmptyObject(e) ? this.each(a.complete, [!1]) : (e = q.extend({}, e),
            ...
            step: function(e) {
                ...
                if (e || i >= s.duration + this.startTime) {
                    ...
                    if (a) {
                        ...
                        s.hide || s.show)
                            for (t in s.animatedProperties)
                                q.style(o, t, s.orig[t]),
                                q.removeData(o, "fxshow" + t, !0),
                                q.removeData(o, "toggle" + t, !0);
                ...
                this.pos = q.easing[s.animatedProperties[this.prop]](this.state, n, 0, 1, s.duration),
        ...
        : q.fn.offset = function(e) {
            ...
            if (t === t.ownerDocument.body)
                return q.offset.bodyOffset(t);
            for (var n, r = t.offsetParent, i = t.ownerDocument, a = i.documentElement, o = i.body, s = i.defaultView, l = s ? s.getComputedStyle(t, null) : t.currentStyle, c = t.offsetTop, u = t.offsetLeft; (t = t.parentNode) && t !== o && t !== a && (!q.support.fixedPosition || "fixed" !== l.position); )
                n = s ? s.getComputedStyle(t, null) : t.currentStyle,
                c -= t.scrollTop,
                u -= t.scrollLeft,
                t === r && (c += t.offsetTop,
                u += t.offsetLeft,
                !q.support.doesNotAddBorder || q.support.doesAddBorderForTableAndCells && xt.test(t.nodeName) || (c += parseFloat(n.borderTopWidth) || 0,
                u += parseFloat(n.borderLeftWidth) || 0),
                r,
                r = t.offsetParent),
                q.support.subtractsBorderForOverflowNotVisible && "visible" !== n.overflow && (c += parseFloat(n.borderTopWidth) || 0,
                u += parseFloat(n.borderLeftWidth) || 0),
                l = n;
            return "relative" !== l.position && "static" !== l.position || (c += o.offsetTop,
            u += o.offsetLeft),
            q.support.fixedPosition && "fixed" === l.position && (c += Math.max(a.scrollTop, o.scrollTop),
        ...
        q.offset = {
            ...
            setOffset: function(e, t, n) {
                ...
                ("absolute" === r || "fixed" === r) && q.inArray("auto", [l, c]) > -1 ? (i = (d = o.position()).top,
        ...
        q.fn.extend({
            ...
            offsetParent: function() {
                return this.map(function() {
                    for (var e = this.offsetParent || O.body; e && !wt.test(e.nodeName) && "static" === q.css(e, "position"); )
                        e = e.offsetParent;
                    return e
                })
            }
    ...
    var b = e("./log")
      ...
      , q = function(e) {
        if ("string" == typeof e) {
            ...
            if (2 === t.length) {
                var n = t[1];
                if ("en" === n || "fr" === n || "es" === n || "pt" === n || "vi" === n || "de" === n || "ru" === n || "id" === n || "ar" === n || "it" === n || "nl" === n)
                    return " "
            }
        }
        return ""
